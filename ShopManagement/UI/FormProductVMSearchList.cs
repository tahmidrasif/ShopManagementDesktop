...
{
    public partial class FormProductVMSearchList : Form
    {
        public List<ProductViewModel> objProductList{get; set;}
        //public List<ProductSearchResultVM> objProductListDup { get; set; }
        public ProductViewModel objProd { get; set; }
        public SalesProductBLL serviceSalesProduct { get; set; }

        public FormProductVMSearchList()
        {
            InitializeComponent();
        }

        public FormProductVMSearchList(List<ProductViewModel> productList)
        {
            InitializeComponent();
